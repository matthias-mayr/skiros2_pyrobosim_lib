...
def skills_and_skiros2(context, *args, **kwargs):
    ...
    load_current_problem_skill = str2bool(LaunchConfiguration("load_current_problem_skill").perform(context))
    ...
    if problem_number > 0:
        ...
        if problem_number > 1 or load_current_problem_skill:
    ...
    if problem_number > 1:
        ...
        if problem_number > 2 or load_current_problem_skill:
            problem_skill_list.append("problem_2")
            solution_skills.append("problem_2_solution")
    if problem_number > 2:
        if problem_number > 3 or load_current_problem_skill:
    ...
    if problem_number > 3:
        ...
        if problem_number > 4 or load_current_problem_skill:
...
def generate_launch_description():
    ...
    ld.add_action(
        DeclareLaunchArgument(
            "load_current_problem_skill",
            default_value="True",
            description="Decides if the problem skill of the current problem should be loaded. Previous solutions will still be loaded.",
        )
    )
