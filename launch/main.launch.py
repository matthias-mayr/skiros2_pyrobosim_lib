...
def skills_and_skiros2(context, *args, **kwargs):
    ...
    basic_compound_skills = "navigate, pick, place, open_openablelocation, close_openablelocation, navigate_to_target"
    ...
    if problem_number > 1:
        skill_list.append(problem_2_waste_skills)
    if problem_number > 2:
        skill_list.append(problem_3_table_skills)
    if problem_number > 3:
        skill_list.append(problem_4_charge_skills)
