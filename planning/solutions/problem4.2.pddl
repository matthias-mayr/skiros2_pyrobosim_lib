...
(:goal (and
	...
	(skiros:contain skiros:Table-15 skiros:Butter-25)
	(skiros:contain skiros:Table-15 skiros:Bread-22)
	(not (skiros:Open skiros:Fridge-17))
	(not (skiros:Open skiros:Pantry-18))
